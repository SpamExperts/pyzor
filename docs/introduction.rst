...
Since the entire system is released under the GPL, people are free to host their own independent servers. There is, however, a well-maintained and actively used public server available (courtesy of `SpamExperts <http://spamexperts.com>`_) at::
...
The project is licensed under the `GNU GPLv2 <http://www.gnu.org/licenses/gpl-2.0.html>`_ license.
